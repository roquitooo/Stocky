...
import { NavLink, useNavigate } from "react-router-dom"; // 1. IMPORTAMOS useNavigate
    ...
    <>
      <Container>
        ...
        <LeftSection>
          ...
          {/* 3. AGREGAMOS EL ONCLICK PARA NAVEGAR AL HOME ("/") */}
...
// ... (El resto de los estilos se mantienen IDÉNTICOS, no hace falta tocarlos) ...
...
/* Solo me aseguro de mostrarte que LogoWrapper ya tiene "cursor: pointer", 
   así que visualmente el usuario sabrá que es clickeable. */
const LogoWrapper = styled.div`
  display: flex;
  align-items: center;
  gap: 12px;
  cursor: pointer; /* <--- ESTO YA LO TENÍAS, PERFECTO */
